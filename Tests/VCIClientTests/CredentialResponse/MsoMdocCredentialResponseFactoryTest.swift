...
class MsoMdocCredentialResponseFactoryTest: XCTestCase {
    func testCredentialResponseConstructionOfMsoMdocVc() {
        do{
            let credentialApiResponseData = """
            {
            ...
            let mdocCredentialResponse = try MsoMdocCredentialResponseFactory().constructResponse(response: credentialApiResponseData)!
            
            XCTAssertNotNil(try mdocCredentialResponse.toJSONString())
        } catch let error {
